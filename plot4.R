##    This script is plot4.R. 
##    It creates plot4.png
##
...
##
##
## Plot 4 Detail                                                                        Four plots 2 by 2
##
png("c:/Users/John/Documents/plot4.png", width = 480, height = 480)
par(mfrow = c(2,2), mar = c(4,4,2,1), oma = c(0,0,2,0))
plot(date.time, j12$Global.Active.Power, type = "l", ylab = "Global Active Power", xlab = "") 
plot(date.time, j12$Voltage, type = "l", ylab = "Voltage", xlab = "datetime") 
...
plot(date.time, j12$Global.Reactive.Power, type = "l", ylab = "Global Reactive Power", xlab = "datetime")
dev.off()
##
##