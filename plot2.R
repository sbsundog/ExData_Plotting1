##    This script is plot2.R. 
##    It creates plot2.png
##
...
##
##                        
##PLOT 2 Detail                                                                  #Date.Time vs Global ACtive Power plot
##
png("c:/Users/John/Documents/plot2.png", width = 480, height = 480)
par(mfrow=c(1,1))
with(j12, plot(date.time, j12$Global.Active.Power, type = "l", ylab = "Global Active Power (kilowatts)", xlab =""))
dev.off()
##